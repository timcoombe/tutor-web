...
<h:header title="Theory Part One"/>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    ...
                    <p><img class="img-responsive" src="/static/lessons/5/one_beat_one_crotchet.png" alt="One beat is one crotchet"/></p>
                </div>
            </div>
        </div>
    </article>
