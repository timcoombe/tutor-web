...
<h:header title="C Major in Second Position"/>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    ...
                    <p>Now you have a two octave scale that you make move anywhere up and down the neck. The first note tells you which major scale it is</p>
                </div>
            </div>
        </div>
    </article>
