        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <h1 class="page-heading">Introduction</h1>
                    <p>
                        Whether you have just taken up the guitar, or you have been playing for a while and need some guidance, this site is for you.
                    ...
                    <p>
                        ...
                        If you feel that you are a bit further on than a beginner, you could dip into the lessons where you like, using the titles as a guide.
                        When you get to lesson five, try going back to lesson one for a recap. This will reinforce the lessons in your mind. Repeat this idea throughout the lessons. At lesson six, recap lesson two and so on. The later lessons will suggest this anyway.
                    </p>

                    <h3>How often should I practice</h3>

                    <p>
                        Practice every day, if possible. It's better to start off with five to ten minutes a day than for thirty minutes once a week.
                        Practice Tip. Try not to leave your guitar in it's case. Have it on a stand or hanging on the wall so that it's easy to pick it up and just start playing.
                     </p>
